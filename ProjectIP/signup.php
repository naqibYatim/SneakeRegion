...
<body bgcolor="#acb2ff">
	...
	<?php
		...
		if(isset($_SESSION['username'])){
			...
			<br>
			<p style="color:#020f85; font-family:Arial Narrow, sans-serif; font-size:30px; text-align:center"><b>You have already login</b></p>
		
			<p style="color:#020f85; font-family:Arial Narrow, sans-serif; font-size:20px; text-align:center"><b>Click <a href='edit_profile.php'>here</a> to update your account informations. Click <a href='logout.php'>logout</a> to use a different account</b></p>
			...
			<form style="text-align:center" action="signup.php" method="post">
				...
				<div class="box">
					...
					<p style="color:#020f85; font-family:Arial Narrow, sans-serif; font-size:20px;"><b>FULL NAME: </b><input type="text" name="name" value="<?php if(isset($_POST['name'])) echo $_POST['name'];?>" style="padding: 10px 20px;"></p>
					
					<p style="color:#020f85; font-family:Arial Narrow, sans-serif; font-size:20px;"><b>USERNAME: </b><input type="text" name="username" value="<?php if(isset($_POST['username'])) echo $_POST['username'];?>" style="padding: 10px 20px;"></p>
					...
					<p style="color:#020f85; font-family:Arial Narrow, sans-serif; font-size:20px;"><b>&emsp;&emsp;PHONE: </b><input type="text" name="phone" value="<?php if(isset($_POST['phone'])) echo $_POST['phone'];?>" style="padding: 10px 20px;"></p>
					
					<p style="color:#020f85; font-family:Arial Narrow, sans-serif; font-size:20px;"><b>&emsp;ADDRESS: </b><input type="text" name="address" value="<?php if(isset($_POST['address'])) echo $_POST['address'];?>" style="padding: 10px 20px;"></p>
					
					<p style="color:#020f85; font-family:Arial Narrow, sans-serif; font-size:20px;"><b>&emsp;&emsp; EMAIL: </b><input type="text" name="email" value="<?php if(isset($_POST['email'])) echo $_POST['email'];?>" style="padding: 10px 20px;"></p>
