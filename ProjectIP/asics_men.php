...
<body bgcolor="#acb2ff">
	...
	<div id="demoFont">Asics Men's Shoes</div>
		...
		<?php
			...
			$query = "SELECT * FROM product
						WHERE product.pd_brand='ASICS'
						AND product.pd_category='men';";
			$result = mysqli_query($dbc, $query);
			
			echo "<form action='asics_men.php' method='post' enctype='multipart/form-data'>";
