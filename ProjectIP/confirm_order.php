...
<?php 
	...
	if(isset($_SESSION['id'])){
			...
			echo "<form action='index.php' method='post' enctype='multipart/form-data'>";
				...
				while($row = mysqli_fetch_array($result)){
					...
					echo "<div id='img_div'>";
						...
						$query2 =  "INSERT INTO order_sneaker(cust_name, cust_username, cust_phone, cust_email, cust_address, cart_image, cart_brand, cart_price, cart_name, cart_size, order_date)
							VALUES('$cust_name', '$cust_username', '$cust_phone', '$cust_email', '$cust_address', '$cart_image', '$cart_brand', '$cart_price', '$cart_name', '$size[$count]', NOW());";
						$result2 = mysqli_query($dbc, $query2);
						
						// get current quantity amount of product
						$query4 =  "SELECT * FROM product
									WHERE product.pd_image='". $cart_image ."'
									AND product.pd_size='". $size[$count] ."'";
		...
		echo "<br>";
		echo "<br>";
		echo "<p>If you did not have account, <a href='signup.php'>click here to sign up</a></p>";
	}
